    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="contact_form_upload" action="../../../Php_droperino/fileBrowser/modalAction/fileUpload.php"
                    ...
                    <span class="btn btn-primary">
                        Upload<input type="file" name="fileToUpload" id="fileToUpload" style="display: none;">
                            ...
                            <input type="text" class="form-control" placeholder="No file uploaded" name="fileToUpload"
                                   readonly>
                        </div>
                    </div>
            ...
            <div class="col-12 text-center" id="notificationLimit" style="background-color:red;font-size:16px;display: none;">
                <b>File is over Limit 50MB</b>
            </div>
            <div class="modal-footer">
                <button type="submit" id="submitFormUpload" class="btn btn-success" data-dismiss="modal">Upload</button>
